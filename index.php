        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <pre>This program is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License 2 as published by the Free Software Foundation.</pre>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    ...
                    <p><strong>When you have configured Postfixadmin, this page will be replaced with a login page.</strong></p>
                    <p>You can now run <a href="setup.php">setup</a> to make sure that all the PHP functions are available for Postfix Admin to run.</p>
